...
#ifndef _TAO_IDL_ONBOARDATCSS_H5MFY8_H_
#define _TAO_IDL_ONBOARDATCSS_H5MFY8_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::OnboardATCS::ShortSeq>
    : public
  ...
  template<>
  class SArg_Traits< ::OnboardATCS::TrainMessage>
    : public
        Var_Size_SArg_Traits_T<
